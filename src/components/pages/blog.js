...
class Blog extends Component {
  ...
  handleDeleteClick(blog){
    ...
    .then(response =>{
      ...
      }); // *filter =pick and choose what vaulues you want in array
  ...
  getBlogItems() {
    ...
    axios.get(`https://eddiezamora.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`, 
  ...
  return (
    <div className="blog-container">
      ...
      <div className="new-blog-link">
        <a onClick={this.handleNewBlogClick}><FontAwesomeIcon
         icon = "plug" /></a>
      </div> ) : null}
